...
Rails.application.routes.draw do
      ...
      resources :assessments, only: %i[edit update destroy] do
        ...
        resources :reference_requests,
          ...
          member do
            ...
            get "resend-email", to: "reference_requests#edit_resend_email"
            post "resend-email", to: "reference_requests#update_resend_email"

            get "resend-email-confirmation",
                to: "reference_requests#resend_email_confirmation"
          end
        end
  ...
  namespace :eligibility_interface, path: "/eligibility" do
    ...
    get "work-experience-referee", to: "work_experience_referee#new"
    post "work-experience-referee", to: "work_experience_referee#create"
  ...
  devise_for :staff,
             skip: %i[sessions invitations passwords confirmations unlocks],
             controllers: {
  ...
  namespace :teacher_interface, path: "/teacher" do
    ...
    resource :application_form, path: "/application", except: %i[destroy] do
      ...
      resources :decision_review_requests,
                ...
                only: %i[index new create edit update] do
        collection do
          get "declaration", to: "decision_review_requests#edit_declaration"
          post "declaration", to: "decision_review_requests#update_declaration"
        end
