...
RSpec.describe "Assessor verifying professional standing", type: :system do
  ...
  it "verify" do
    ...
    and_i_submit_no_on_the_request_form
    then_i_see_the(
      :assessor_professional_standing_request_page,
      application_form_id:,
      assessment_id:,
    ...
    when_i_click_request_lops_verification
    and_i_submit_yes_on_the_request_form
    then_i_see_the(
      :assessor_professional_standing_request_page,
      application_form_id:,
      assessment_id:,
  ...
  def and_i_submit_yes_on_the_request_form
    assessor_request_professional_standing_request_page.submit_yes
  end

  def and_i_submit_no_on_the_request_form
    assessor_request_professional_standing_request_page.submit_no
  end
