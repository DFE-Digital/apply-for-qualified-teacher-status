...
RSpec.describe UpdateTRSTRNRequestJob, type: :job do
  describe "#perform" do
    ...
    # TODO: This can be removed once the DQTTRNRequest model has been removed and fully migrated
    context "when instance passed in is DQTTRNRequest instead of TRSTRNRequest" do
      ...
      context "with an initial request" do
        ...
        context "when a TRSTRNRequest exists for the application form" do
          let!(:trs_trn_request) do
            create(
              :trs_trn_request,
              :initial,
      ...
      context "with a complete request" do
        ...
        it "doesn't change the stage" do
          expect { perform }.not_to change(
            dqt_trn_request.application_form,
            :stage,
          )
        end
