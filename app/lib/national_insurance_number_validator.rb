...
class NationalInsuranceNumberValidator
  def initialize(national_insurance_number:)
    @national_insurance_number = national_insurance_number

    @national_insurance_number_part_one = national_insurance_number.to_s[0..1]
    @national_insurance_number_part_two = national_insurance_number.to_s[2..7]
    @national_insurance_number_part_three = national_insurance_number.to_s[8]
  end
