  ...
  class NameAndDateOfBirthForm < BaseForm
    ...
    def initialize(attributes = {})
      ...
      if attributes[:national_insurance_number].present?
        self.national_insurance_number_part_one = attributes[:national_insurance_number][0..1]
        self.national_insurance_number_part_two = attributes[:national_insurance_number][2..7]
        self.national_insurance_number_part_three = attributes[:national_insurance_number][8]
      end
    end
    ...
    def national_insurance_number_validator
      @national_insurance_number_validator ||=
        NationalInsuranceNumberValidator.new(national_insurance_number:)
    end
    ...
    def national_insurance_number_parts_valid
      return if national_insurance_number.blank? || national_insurance_number_validator.valid?
