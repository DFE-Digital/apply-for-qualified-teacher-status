!(function (t, e) {
  ...
  (function (t) {
        ...
        (function () {
          if (!window.Element || window.HTMLElement) {
            ...
            var t,
              ...
              n = e.appendChild(document.createElement("iframe")).contentWindow
                .document,
            ...
            a.attachEvent("onpropertychange", function (t) {
              ...
              r() ||
                ((document.onreadystatechange = r), (t = setInterval(r, 25))),
            ...
            d(
              ...
              function () {
                ...
                if (!(e[n] = !0) === u) {
                  for (
                    var o,
                      i = h.mirror || document.createElement("div"),
                      r = i.childNodes,
                      s = r.length,
                      a = 0;
                    a < s;
    ...
    (n.prototype.initHeaderAttributes = function (e, t) {
      ...
      s.addEventListener("focusin", function (t) {
        e.classList.contains(n.sectionHeaderFocusedClass) ||
          (e.className += " " + n.sectionHeaderFocusedClass);
      }),
                    ...
                    function () {
                      ...
                      s._events || (s._events = {}),
                        s._events[t] ||
                          ...
                          (s._events[t].list = []),
                          s.attachEvent &&
                            s.attachEvent("on" + t, s._events[t])),
  ...
  (i.prototype.init = function () {
    ...
    (c.prototype.init = function () {
      var t = this.$module;
      t &&
        (t.focus(), t.addEventListener("click", this.handleClick.bind(this)));
    }),
    ...
    (t.initAll = function p(t) {
      var e =
        "undefined" != typeof (t = void 0 !== t ? t : {}).scope
          ? t.scope
          : document;
      r(e.querySelectorAll('[data-module="govuk-button"]'), function (t) {
        ...
        r(
          e.querySelectorAll('[data-module="govuk-character-count"]'),
          function (t) {
            new s(t).init();
          }
        ),
        ...
        r(
          e.querySelectorAll('[data-module="govuk-notification-banner"]'),
          function (t) {
            new l(t).init();
          }
        ),
